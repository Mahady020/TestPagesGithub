<?php 
    if ($_SERVER["REQUEST_METHOD"]=="POST") {
        ...
        $call_query= $bdconnection->query("SELECT * FROM cimen_musteri_tablo where musteri_id=$kontrol_kod;");
        ...
        { ?>
                ...
                <body>
                    ...
                    <div id="section-div">
                                ...
                                <section>
                                                <div class="rez-body">
                                                    <form action="cimen_otel_kontrol_update_html.php" method="post">
                                                        <div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <a href="http://localhost/gezi_tanitim_turizm_herberi/web_site/cimenler_otel_anasayfa.html.php" 
