...
<head>
    ...
    <link rel="stylesheet" href="css/gumus_otel_rez.css">
 ...
 <section>
    <div class="dash-board">
        ...
        <div class="main-dash-content">
            <form action="gumus_rezerv.php" method="post">
                <table class="table-icerik">
                            ...
                            if($_SERVER["REQUEST_METHOD"]=="POST")
                             {
                                ...
                                if(isset($_POST["oda_1"]))
                                {
                                    $oda_isim="Superior Aile Odasi";
                                    
                                }
                                if(isset($_POST["oda_2"]))
                                {
                                    $oda_isim="Suit Oda";
                                
                                }
                                if(isset($_POST["oda_3"]))
                                {
                                    $oda_isim="Standart Oda-Tek kisilik";
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td class="t-i"><input type="number" name="telefon"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="t-i"><input type="text" name="adres"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="t-i button" colspan="2"><input type="submit" value="Reserv"></td>
                        </tr>
                </table>
            </form>
