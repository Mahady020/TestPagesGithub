        ...
        $no=$record["musteri_id"];
            ...
            if($_SERVER["REQUEST_METHOD"]=="POST")
            {
                ...
                else
                {
                  ...
                  echo "<script>alert('18 yasinda ve uzeri olmalisiniz !');</script>";
                ...
                /*-------------------------------------------giris ve cikis tarih farkli ------------------------------------------------- */
                    ...
                    {
                        echo "<script>alert('giris tarih, tarihinden buyuk veya esit olmalidir!');</script>";
                    }

                $guncel_query=$bdconnection->prepare("UPDATE cimen_musteri_tablo SET
                    musteri_ad= :mu_ad,
                    ...
                    WHERE musteri_id=:mu_musteri_id");
                    $guncel=$guncel_query->execute(array(
                        "mu_musteri_id"=>"$no",
                        "mu_ad"=> "$ad",
                        "mu_soyad"=>"$soyad",
                        "mu_telefon"=>"$telefon",
