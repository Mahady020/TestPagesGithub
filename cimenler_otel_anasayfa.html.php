...
<head>
    ...
    <link rel="stylesheet" href="css/cimenler_anasayfa.css">
...
<section>
    <div class="otelkart">
        ...
        <div class="odalar">
            <img src="resimler/cimenler_oda1.jpg" class="oda-resim" alt="">
            <h3 class="oda-tip">Junior Süit</h3>
            <p class="oda-fiyat">Fiyat : 4.500 TL</p>
            <p class="oda-fiyat" style="color:black; font-size:smaller">ücretsiz kahvaltı, <br> wifi internet, <br>TV Kanalları</p>
            <form class="form-b-i" action="cimenler_1_rezerv_html.php" method="post">
                    <input class="form-buton" type="submit" name="oda_4" value="Rezerv">
            </form>
        </div>


        <div class="odalar">
            <img src="resimler/cimenler_oda2.jpg" class="oda-resim" alt="">
            <h3 class="oda-tip">Suit Oda</h3>
            <p class="oda-fiyat">Fiyat : 4.000 TL</p>
            <p class="oda-fiyat" style="color:black; font-size:smaller">ücretsiz kahvaltı, <br> wifi internet, <br>balkon</p>
            <form name="f1" class="form-b-i" action="cimenler_1_rezerv_html.php" method="post">
                    <input class="form-buton" type="submit" name="oda_5" value="Rezerv">
            </form>
        </div>


        <div class="odalar">
        <img src="resimler/cimenler_oda3.jpg" class="oda-resim" alt="">
        <h3 class="oda-tip">Tek kisilik</h3>
        <p class="oda-fiyat">Fiyat : 2.000 TL</p>
        <p class="oda-fiyat" style="color:black; font-size:smaller">ücretsiz kahvaltı, <br> wifi internet, <br>Gazete</p>
        <form name="f1" class="form-b-i" action="cimenler_1_rezerv_html.php" method="post">
                    <input class="form-buton" type="submit" name="oda_6" value="Rezerv">
            </form>
        </div>
        <div class="kontrol-odalar">
            ...
            <form class="kontrol" action="cimen_otel_kontrol_html.php" method="post">
