...
<head>
    ...
    <link rel="stylesheet" href="css/gumus_otel_anasayfa.css">
...
<section>
    <div class="otelkart">
        ...
        <div class="odalar">
            <img src="resimler/gumus_roo1.JPG" class="oda-resim" alt="">
            <h3 class="oda-tip">Superior Aile Odasi</h3>
            <p class="oda-fiyat">Fiyat : 5.000 TL</p>
            <p class="oda-fiyat" style="color:black; font-size:smaller">ücretsiz kahvaltı, <br> wifi internet, <br>balkon</p>
            
            <form class="form-b-i" action="gumus_otel_rez_html.php" method="post">
                    <input class="form-buton" type="submit" name="oda_1" value="Rezerv">
            </form>
        ...
        <div class="odalar">
            <img src="resimler/gumus_roo2.JPG" class="oda-resim" alt="">
            <h3 class="oda-tip">Suit Oda</h3>
            <p class="oda-fiyat">Fiyat : 4.000 TL</p>
            <p class="oda-fiyat" style="color:black; font-size:smaller">ücretsiz kahvaltı, <br> wifi internet, <br>balkon</p>
            <form class="form-b-i" action="gumus_otel_rez_html.php" method="post">
                    <input class="form-buton" type="submit" name="oda_2" value="Rezerv">
            </form>
        </div>


        <div class="odalar">
        <img src="resimler/gumus_roo3.JPG" class="oda-resim" alt="">
        <h3 class="oda-tip">Standart Oda-Tek kisilik</h3>
        <p class="oda-fiyat">Fiyat : 3.500 TL</p>
        <p class="oda-fiyat" style="color:black; font-size:smaller">ücretsiz kahvaltı, <br> wifi internet</p>
        <form class="form-b-i" action="gumus_otel_rez_html.php" method="post">
                    <input class="form-buton" type="submit" name="oda_3" value="Rezerv">
            </form>
        </div>
        ...
        <div class="kontrol-odalar">
            ...
            <form class="kontrol" action="gumus_otel_kontrol_html.php" method="post">
