...
<head>
    ...
    <title>Cimenler Otel</title>
    <link rel="stylesheet" href="css/cimenler_1_rezerv_.css">
 ...
 <section>
    <div class="dash-board">
        ...
        <div class="side">
            ...
            <p>Odanızı rezerve etmek için formu doldurun ve daha fazla doğrulama için doğru isimleri girdiğinizden emin olun ve rezervasyon durumunuzu görmeyi etkinleştirin.
            <span style="color: red">Rezervasyon kodunuzu paylaşmayın!</span></p>
        </div>

        <div class="main-dash-content">
            <form action="cimenler_rezerv_.php" method="post">
                <table class="table-icerik">
                            ...
                            if($_SERVER["REQUEST_METHOD"]=="POST")
                             {
                                ...
                                if(isset($_POST["oda_4"]))
                                {
                                    $oda_isim="Junior Süit";
                                    
                                }
                                if(isset($_POST["oda_5"]))
                                {
                                    $oda_isim="Suit Oda";
                                
                                }
                                if(isset($_POST["oda_6"]))
                                {
                                    $oda_isim="Tek kisilik";
                                   
                                }
                             }
                            
                            ?>
                            <td class="t-d">Oda isim</td>
                            <td class="t-i"><input type="text" name="" value=" <?php echo $oda_isim;?> " readonly></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="t-i"><input type="date" name="giris_tarih" id="" required></td>
                            <td class="t-i"><input type="date" name="cikis_tarih" id="" required></td>
                        </tr>
                        <tr>
                            <td class="t-d">Adiniz</td>
                            <td class="t-i"><input type="text" name="ad" required></td>
                        </tr>
                        <tr>
                            <td class="t-d">Soyadiniz</td>
                            <td class="t-i"><input type="text" name="soyad" required></td>
                        </tr>
                         <tr>
                            <td class="t-d">Telefon</td>
                            <td class="t-i"><input type="number" name="telefon" required></td>
                        </tr>
                        <tr>
                            <td class="t-d">E-posta</td>
                            <td class="t-i"><input type="email" name="eposta" required></td>
                        </tr>
                       
                        
                        <tr>
                            <td class="t-d">TC kimlik </td>
                            <td class="t-i"><input type="number" name="kimlik" required></td>
                        </tr>
                        <tr>
                            <td class="t-d">Dogum Tarih</td>
                            <td class="t-i"><input type="date" name="dogum_tarih" required></td>
                        </tr>
                        <tr>
                            <td class="t-d">Adres</td>
                            <td class="t-i"><input type="text" name="adres" required></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="t-i button" colspan="2"><input type="submit" value="Rezerv"></td>
                        </tr>
                </table>
            </form>
