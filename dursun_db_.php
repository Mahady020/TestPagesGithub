...
if ($_SERVER["REQUEST_METHOD"]=="POST") {
    ...
    try {
        $con_query=$bdconnection->prepare("INSERT INTO dursun_yorumlar_tablo SET
       ...
       ");
        ...
        if($con_query && $record_bir)
        {
             echo "<script>
                    ...
                    window.location.href = 'http://localhost/gezi_tanitim_turizm_herberi/web_site/dursun_erkek_ogrenci_yurdu_html.php';
                  </script>";
         
            exit();
             // header("location: http://localhost/gezi_tanitim_turizm_herberi/konaklama/dursun_erkek_ogrenci_yurdu_html.php");
             // die();
        }
