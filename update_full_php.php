...
<?php
        ...
        $call_query= $bdconnection->query("SELECT * FROM gumus_musteri_tablo ORDER BY musteri_id DESC ");
        ...
        $no=$record["musteri_id"];
            ...
            if($_SERVER["REQUEST_METHOD"]=="POST")
            {
                ...
                $guncel_query=$bdconnection->prepare("UPDATE gumus_musteri_tablo SET
                    musteri_ad= :mu_ad,
