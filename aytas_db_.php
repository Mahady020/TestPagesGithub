...
if ($_SERVER["REQUEST_METHOD"]=="POST") {
    ...
    try {
        $con_query=$bdconnection->prepare("INSERT INTO aytas_yorumlar_tablo SET
       ...
       ");
        ...
        if($con_query && $record_bir)
        {
            echo "<script>
                    ...
                    window.location.href = 'http://localhost/gezi_tanitim_turizm_herberi/web_site/aytas_yurt_anasayfa_html.php';
                  </script>";
         
            exit();
           // header("location: http://localhost/gezi_tanitim_turizm_herberi/konaklama/aytas_yurt_anasayfa_html.php");
        }
