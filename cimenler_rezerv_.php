...
if($_SERVER["REQUEST_METHOD"]="POST")
{
  ...
  try {
    ...
    $con_query=$bdconnection->prepare("INSERT INTO cimen_musteri_tablo SET
    musteri_ad= :mu_ad,
    ...
    {
        header("location: http://localhost/gezi_tanitim_turizm_herberi/web_site/cimenler_2_rezerv_html.php");
    }
}
