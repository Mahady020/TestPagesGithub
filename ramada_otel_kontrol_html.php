<?php 
    if ($_SERVER["REQUEST_METHOD"]=="POST") {
        ...
        $call_query= $bdconnection->query("SELECT * FROM ramada_musteri_tablo where musteri_id=$kontrol_kod;");
        ...
        { ?>
                ...
                <body>
                    ...
                    <div id="section-div">
                                ...
                                <section>
                                                <div class="rez-body">
                                                    <form action="ramada_otel_kontrol_update_html.php" method="post">
                                                        <div>
