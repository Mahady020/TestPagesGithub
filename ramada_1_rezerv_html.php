 ...
 <section>
    ...
    <div class="side">
        ...
        <div class="main-dash-content">
            <form action="ramada_rezerv.php" method="post">
                <table class="table-icerik">
                            ...
                            if($_SERVER["REQUEST_METHOD"]=="POST")
                             {
                                ...
                                if(isset($_POST["oda_7"]))
                                {
                                    $oda_isim="İki Yataklı Oda";
                                    
                                }
                                elseif(isset($_POST["oda_8"]))
                                {
                                    $oda_isim="Suit Oda";
                        ...
                        <tr>
                            ...
                            <td class="t-i button" colspan="2"><input type="submit" value="Rezerv" required></td>
                        </tr>
                </table>
            </form>
