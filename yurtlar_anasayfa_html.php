...
<body>
    ...
    <section id="destinations" class="destinations">
        <h3>Gumushane Merkez Yurtlar</h3>
        <div class="destination-container">
            <div class="destination-card">
                <img src="resimler/aytas.jpeg" alt="Gumushane">
                <h5>Aytas Ogrenci Yurdu</h5>
                
                <p></p>
                <a href="http://localhost/gezi_tanitim_turizm_herberi/web_site/aytas_yurt_anasayfa_html.php" class="btn">SEC</a>
            </div>
            <div class="destination-card">
                <img src="resimler/elit_kiz_ogrenci_yurdu.jpg" alt="Gumushane">
                <h5>Elit Kiz Ogrenci Yurdu</h5>
    
                <p></p>
                <a href="http://localhost/gezi_tanitim_turizm_herberi/web_site/elit_yutru_anasayfa_html.php" class="btn">SEC</a>
            </div>
            <div class="destination-card">
                <img src="resimler/ozel-erkek_ogrenci_pansiyon.jpg" alt="Gumushane">
                <h5>Dursun Erkek Ogrenci Yurdu</h5>
                
                <p></p>
                <a href="http://localhost/gezi_tanitim_turizm_herberi/web_site/dursun_erkek_ogrenci_yurdu_html.php" class="btn">SEC</a>
            </div>
